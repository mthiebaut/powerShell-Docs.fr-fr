...
Consultez la rubrique [Envoi de commentaires via des médias sociaux ou des commentaires](../how-to/working-with-items/social-media-feedback.md) pour plus d’informations sur la procédure à suivre.
