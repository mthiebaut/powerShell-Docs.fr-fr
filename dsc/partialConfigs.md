...
## <a name="partial-configurations-in-push-mode"></a>Configurations partielles en mode par émission
...
>**Remarque :** L’utilisateur exécutant le 
...
## <a name="partial-configurations-in-mixed-push-and-pull-modes"></a>Configurations partielles en modes mixtes par émission et par extraction
...
### <a name="mixed-push-and-pull-modes-using-configurationnames"></a>Modes mixtes par émission et par extraction à l’aide de ConfigurationNames
...
### <a name="mixed-push-and-pull-modes-using-configurationid"></a>Modes mixtes par émission et par extraction à l’aide de ConfigurationID
