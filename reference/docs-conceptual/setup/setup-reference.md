...
---
# <a name="setup-guide"></a>Guide d'installation

- [Installation de PowerShell Core sur macOS et Linux](Installing-PowerShell-Core-on-macOS-and-Linux.md)
...
- [Installation du Windows PowerShell SDK](Installing-the-Windows-PowerShell-SDK.md)
- [Référence d’installation](setup-reference.md)
