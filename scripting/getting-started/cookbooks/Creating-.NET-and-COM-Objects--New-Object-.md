...
# <a name="creating-net-and-com-objects-newobject"></a>Création d’objets .NET et COM (New-Object)
...
### <a name="using-newobject-for-event-log-access"></a>Utilisation de l’applet de commande New-Object pour l’accès au journal des événements
...
#### <a name="using-constructors-with-newobject"></a>Utilisation de constructeurs avec l’applet de commande New-Object
...
#### <a name="accessing-a-remote-event-log-with-newobject"></a>Accès à un journal des événements à distance avec New-Object
...
### <a name="creating-com-objects-with-newobject"></a>Création d’objets COM avec New-Object
...
### <a name="getting-warnings-about-net-frameworkwrapped-com-objects"></a>Obtention d’alertes sur les objets COM encapsulés .NET Framework
