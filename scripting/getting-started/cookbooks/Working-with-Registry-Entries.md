...
L’expansion de chemin d’accès fonctionne de la même façon que dans le système de fichiers. Ainsi, à partir de cet emplacement, vous pouvez obtenir la liste **ItemProperty** pour **HKLM:\SOFTWARE\Microsoft\Windows\Help** en utilisant l’applet de commande **Get-ItemProperty -Path ..\Help**.
...
> [!NOTE]Vous pouvez ajouter une entrée de Registre à plusieurs emplacements en spécifiant un tableau de valeurs pour le paramètre **Path** :
