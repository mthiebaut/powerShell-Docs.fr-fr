...
[Windows PowerShell Tip of the Week: Multi-Select List Boxes - And More! (Astuce Windows PowerShell de la semaine : Zones de liste à sélection multiple, et bien plus encore !)](http://technet.microsoft.com/library/ff730950.aspx)
